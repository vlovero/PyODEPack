...
def solveIVP(f: Callable, y0: ArrayLike, teval: ArrayLike, args: tuple = None, out: ndarray = None,
    ...
    atol : float, optional
        absolute error tolerance, by default 1e-6
    rtol : float, optional
        relative error tolerance, by default 1e-3
    min_step : float, optional
        minimum allowable step, by default 1e-6
    max_step : float, optional
        maximum allowable step, by default 1
    window : ArrayLike, optional
        computational window solution must stay inside, by default None
    method : int, optional
        which integration method to use, by default 1
