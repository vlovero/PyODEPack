...
namespace verner65e
{
    ...
    using stepper64_t = erk::RKStepper<double, funcT, 9, 10, 6,
        nodes_f64, 9, coefficients_f64,
        interpolant_f64,
        weights_f64,
        deltas_f64, scalar>;

    template <typename funcT, bool scalar = false>
    using stepper32_t = erk::RKStepper<float, funcT, 9, 10, 6,
        nodes_f32, 9, coefficients_f32,
        interpolant_f32,
        weights_f32,
        deltas_f32, scalar>;
